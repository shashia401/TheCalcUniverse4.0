...
import config from '../../../src/calculators/math/gpa/index';
...
describe('mode', () => {
  ...
  it('should return results for valid demo inputs', () => {
    ...
    // Ensure courses has at least one entry for the custom input
    demoValues['courses'] = '[{"name":"Math","grade":"A","credits":"3"}]';
